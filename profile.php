...
<body class="" onload="get_notifs(5)">
  <section class="vbox">
                      ...
                      <div class="row">
                          <div class="col-md-4">
                              ...
                              <?php
                                if(isset($_SESSION['user']))
                                {
                                  if(get_loggedin_user_id()==$user)
                                  {
                                    echo "<a href='#' onclick=\"changedp()\" class='btn' data-toggle='tooltip' title='Change profile picture' class='btn' style='background-color: rgba(0,0,0,0.2);color:#ffffff;position: absolute;margin-top: -82px;margin-left:267px'><i class='ion-edit'></i></a>";
                                  }
                                }
                              ?>
...
<div id="dp" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <script>
      ...
      function get_notifs(user)
      {
        ...
        $.post("handler/get_written_post.php",{user:user},function(response){
    ...
    function edit_qualification_details()
    {
    ...
    $('#summary_submit').submit(function(e){
      e.preventDefault();
          $.ajax({
            url:"handler/update_summary_details.php",
            type:"POST",
            data: new FormData(this),
            cache:false,
            contentType:false,
